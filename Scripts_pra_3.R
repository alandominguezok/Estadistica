...
#Densidad de la N(3,7) y de la N(3,1)
x <- seq(-3,9,0.1)
y<-dnorm(x,mean=3,sd=sqrt(7)) 
plot(x,y,type = "l", main='Gráfico de la densidad de una N(3,7)', lwd = 2, col = "blue")# lw da el grosor

#Dibujamos las dos densidades juntas

plot(x,y,type = "l", main='Gráfico de las densidades de una N(3,7) (azul) y N(3,1) (rojo)', lwd = 2, col = "blue", ylim=c(0,0.4))# lw da el grosor
lines(x, dnorm(x,mean=3, sd=1), col="red") #Agregamos la densidad de la N(3,1) 
